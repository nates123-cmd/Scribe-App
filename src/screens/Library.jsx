// Library — list of all notes with kind filters, keyword search, topic tags.
// Ported 1:1 from the prototype's scribe-screens-1.jsx → LibraryScreen.
...
export function LibraryScreen() {
  ...
  return <div style={{ padding: '28px 40px 60px', maxWidth: 1000, margin: '0 auto' }}>
    <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 22 }}>
      ...
      <Btn kind="primary" icon="plus" onClick={() => go({ screen: 'capture' })}>New</Btn>
    </div>
      ...
      return <div key={n.id} onClick={() => go({ screen: 'note', id: n.id })}
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 11, minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div style={{ fontFamily: FONT, fontSize: 11.5, color: t.t3, marginTop: 2, display: 'flex', alignItems: 'center', gap: 6 }}>
