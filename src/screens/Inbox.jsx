...
export function InboxScreen() {
  ...
  return <div style={{ padding: '28px 40px 60px', maxWidth: 760, margin: '0 auto' }}>
    <h1 style={{ fontFamily: FONT, fontSize: 28, fontWeight: 700, color: t.t1, letterSpacing: '-0.02em', margin: '0 0 6px' }}>Inbox</h1>
    ...
    <div style={{ border: '1px dashed ' + t.line2, borderRadius: 12, padding: '18px 17px',
      ...
      <Icon n="sparkles" s={15} c={t.t3} />Port from prototype: scribe-screens-1.jsx → InboxScreen
    </div>
  </div>
}
